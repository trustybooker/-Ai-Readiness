...
export async function logConversationLead({ result, message, history = [], channel = 'web' }) {
  ...
  const title = `[Secretary] ${String(lead.name || 'Visitor').slice(0, 60)} — ${String(lead.path || 'conversation').slice(0, 80)}`;
