...
(function () {
  var config = window.AIKOLLEGE_SITE_CONFIG || window.FIFYNOW_SITE_CONFIG || {};
  ...
  if (!recognition) { voiceButton.disabled = true; voiceButton.title = 'Voice input is not supported in this browser'; voiceStatus.textContent = 'Voice input is unavailable in this browser; typing still works.'; }
