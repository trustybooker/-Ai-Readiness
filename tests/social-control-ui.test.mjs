...
test('Owner Studio loads dedicated social control',()=>{assert.match(loader,/social-control\.js/);assert.match(ui,/dataset\.socialControl/);assert.match(ui,/Draft → review → approve → schedule/);});
