...
### Layer 1: Conversion page

Path:

1. Free AI readiness score.
2. Recommended path.
3. First-party lead capture.
4. Human review.
5. Training, audit, sprint, or implementation.
...
- How to prove AI skills on a resume.
- Why train before AI automation?
- What is an AI readiness audit?
- What should employees not put into AI tools?
- How should small businesses start AI safely?

Every answer page should answer directly near the top, give practical examples, avoid fake claims, and link back to the checklist, score, Lab, or human review.
...
3. AI Starter Pass
4. AI Job and Productivity Pass
5. Business AI Readiness Audit
6. Team Training Sprint
7. AI Implementation Project
8. AI Readiness Lab
9. AI Operations Partner for qualified companies

## Course and credential standard
...
1. Form tries first-party tracker.
2. Tracker creates a GitHub Issue lead record when configured.
3. If tracker is unavailable, fallback delivery protects the lead.
...
When starting a session for this project:

1. Remind Orrett of the platform skill stack.
2. Ask whether any new skills were added.
3. If new skills were added, update `docs/skill-registry.md` and the reminder brief.
4. Audit current repo and PR state before acting.
5. Continue from the highest-priority launch gate.

## Done means

Repo-side done means code, docs, validation, course assets, lead system, and launch runbook are ready.

Production-ready means live deployment and external tests are verified: deployed URL, visual preview, lead tracker, fallback delivery, payment links, booking link, analytics if chosen, schema, and truth audit.
